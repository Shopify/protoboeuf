          ...
          while true
            ...
            if tag == 0xa
              ...
              while tag == 0xa
                ...
                map[
                  key
                ] = ::ProtoBoeuf::Google::Protobuf::Value.allocate.decode_from(
                  buff,
                  index,
                  index += msg_len
                )
        ...
        def decode_from(buff, index, len)
          ...
          while true
            ...
            if tag == 0x2a
              ...
              @struct_value =
                ::ProtoBoeuf::Google::Protobuf::Struct.allocate.decode_from(
                  buff,
                  index,
                  index += msg_len
                )
            ...
            if tag == 0x32
              ...
              @list_value =
                ::ProtoBoeuf::Google::Protobuf::ListValue.allocate.decode_from(
                  buff,
                  index,
                  index += msg_len
                )
          ...
          while true
            ...
            if tag == 0xa
              ...
              while true
                ...
                list << ::ProtoBoeuf::Google::Protobuf::Value.allocate.decode_from(
                  buff,
                  index,
                  index += msg_len
                )
