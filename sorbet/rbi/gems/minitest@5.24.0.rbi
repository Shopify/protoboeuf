...
module Minitest
  class << self
    ...
    # source://minitest-color/0.0.2/lib/minitest/color_plugin.rb#10
    def plugin_color_init(options); end

    # source://minitest-color/0.0.2/lib/minitest/color_plugin.rb#4
...
class Minitest::PrideIO
  ...
  # source://minitest//lib/minitest/pride_plugin.rb#96
  def method_missing(msg, *args); end

  # Color a string.
  #
  # source://minitest//lib/minitest/pride_plugin.rb#89
  ...
  # source://minitest//lib/minitest/pride_plugin.rb#73
  def puts(*o); end
...
#
# source://minitest//lib/minitest/pride_plugin.rb#106
class Minitest::PrideLOL < ::Minitest::PrideIO
  # @return [PrideLOL] a new instance of PrideLOL
  #
  # source://minitest//lib/minitest/pride_plugin.rb#109
  def initialize(io); end
...
# source://minitest//lib/minitest/pride_plugin.rb#107
